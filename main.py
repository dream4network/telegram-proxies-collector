...
url = 'https://raw.githubusercontent.com/dream4network/telegram-configs-collector/main/telegram channels.json'
...
def create_country_table(country_path):
    ...
    country_url_pattern = '[Subscription Link](https://raw.githubusercontent.com/dream4network/telegram-proxies-collector/main/countries/{country_code}/proxies)'
